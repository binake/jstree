...
! function(e, t) {
	...
	const r = new class {
		...
		a = {
			file: {
				...
				save: function(e, t, i) {
					var n;
					if ("function" == typeof r.w.Blob) n = new Blob([e], {
						type: t
					});
					else {
						...
						var s = (r.w.URL || r.w.webkitURL).createObjectURL(n),
							a = r.c("a");
						if ("download" in a) {
							a.style.visibility = "hidden", a.href = s, a.download = i, r.d.body.appendChild(a);
			...
			json: {
				...
				merge: function(e, t) {
					for (var i in t) i in e ? "object" != typeof e[i] || "[object object]" != Object.prototype.toString.call(e[i]).toLowerCase() || e[i].length ? e[i] = t[i] : a.json.merge(e[i], t[i]) : e[i] = t[i];
					return e
				}
			},
			uuid: {
	...
	class l {
		constructor(e, t, i, n, o, r, a, d) {
			e ? "number" == typeof t ? (void 0 === d && (d = !0), this.id = e, this.index = t, this.topic = i, this.data = n || {}, this.isroot = o, this.parent = r, this.direction = a, this.expanded = !!d, this.children = [], this._data = {}) : s.error("invalid node index") : s.error("invalid node id")
		}
		get_location() {
	...
	class h {
		...
		get_node(e) {
			return e in this.nodes ? this.nodes[e] : (s.warn("the node[id=" + e + "] can not be found"), null)
		}
		set_root(e, t, i) {
			return null == this.root ? (this.root = new l(e, 0, t, i, !0), this._put_node(this.root), this.root) : (s.error("root node is already exist"), null)
		}
		add_node(e, i, n, o, r, a, d) {
			...
			return e.isroot && (h.direction = r || t.right), this._put_node(h) ? (e.children.push(h), this._update_index(e)) : (s.error("fail, the node id '" + h.id + "' has been already exist."), h = null), h
		}
		...
		get_node_before(e) {
			if (!l.is_node(e)) {
				...
				return t ? this.get_node_before(t) : (s.error("the node[id=" + e + "] can not be found."), null)
			}
		...
		get_node_after(e) {
			if (!l.is_node(e)) {
				var t = this.get_node(e);
				return t ? this.get_node_after(t) : (s.error("the node[id=" + e + "] can not be found."), null)
			}
			if (e.isroot) return null;
			var i = e.index;
		...
		move_node(e, t, i, n) {
			return l.is_node(e) ? (i || (i = e.parent.id), this._move_node(e, t, i, n)) : (s.error("the parameter node " + e + " is not a node."), null)
		}
		...
		_move_node(e, i, n, o) {
			if (e && n) {
				...
				e.parent.isroot ? o == t.left ? e.direction = o : e.direction = t.right : e.direction = e.parent.direction, this._move_node_internal(e, i), this._flow_node_direction(e)
			}
			return e
		}
		remove_node(e) {
		...
		_put_node(e) {
			return e.id in this.nodes ? (s.warn("the node_id '" + e.id + "' has been already exist."), !1) : (this.nodes[e.id] = e, !0)
		}
		_update_index(e) {
			if (e instanceof l) {
			...
			node_tree: {
				...
				_build_node: function(e) {
					...
					if (e instanceof l) {
						...
						if (e.parent && e.parent.isroot && (n.direction = e.direction == t.left ? "left" : "right"), null != e.data) {
							var o = e.data;
						...
						if (r.length > 0) {
							n.children = [];
							for (var a = 0; a < r.length; a++) n.children.push(i._build_node(r[a]))
						}
						return n
					}
				}
			...
			node_array: {
				...
				_array_node: function(e, i) {
					...
					if (e instanceof l) {
						...
						if (e.parent && (o.parentid = e.parent.id), e.isroot && (o.isroot = !0), e.parent && e.parent.isroot && (o.direction = e.direction == t.left ? "left" : "right"), null != e.data) {
							var s = e.data;
							for (var r in s) o[r] = s[r]
						}
						i.push(o);
						for (var a = e.children.length, d = 0; d < a; d++) n._array_node(e.children[d], i)
					}
				}
			},
			freemind: {
				...
				_load_node: function(e, i, n) {
					...
					delete _.expanded;
					var p = n.getAttribute("POSITION"),
						v = null;
					p && (v = "left" == p ? t.left : t.right);
					var f = null;
					f = i ? e.add_node(i, s, r, _, v, c) : e.set_root(s, r, _);
					var g = n.childNodes,
						m = null;
					for (h = 0; h < g.length; h++) 1 == (m = g[h]).nodeType && "node" == m.tagName && o._load_node(e, f, m)
				},
				...
				_build_map: function(e, i) {
					var n = u.freemind,
						o = null;
					e.parent && e.parent.isroot && (o = e.direction === t.left ? "left" : "right"), i.push("<node"), i.push(' ID="' + e.id + '"'), o && i.push(' POSITION="' + o + '"'), e.expanded || i.push(' FOLDED="true"'), i.push(' TEXT="' + n._escape(e.topic) + '">');
					var s = e.data;
					if (null != s)
						for (var r in s) i.push('<attribute NAME="' + r + '" VALUE="' + s[r] + '"/>');
	...
	class c {
		...
		load(e) {
			var t = null,
				i = null;
			return "node_array" == (t = "object" == typeof e ? e.format ? e.format : "node_tree" : "freemind") ? i = u.node_array.get_mind(e) : "node_tree" == t ? i = u.node_tree.get_mind(e) : "freemind" == t ? i = u.freemind.get_mind(e) : "text" == t ? i = u.text.get_mind(e) : s.warn("unsupported format"), i
		}
		get_data(e) {
			var t = null;
			return "node_array" == e ? t = u.node_array.get_data(this.jm.mind) : "node_tree" == e ? t = u.node_tree.get_data(this.jm.mind) : "freemind" == e ? t = u.freemind.get_data(this.jm.mind) : "text" == e ? t = u.text.get_data(this.jm.mind) : s.error("unsupported " + e + " format"), t
		}
	}
	class p {
		constructor(e, t) {
		...
		reset() {
			s.debug("layout.reset"), this.bounds = {
				n: 0,
				s: 0,
				w: 0,
				e: 0
		...
		calculate_next_child_direction(e) {
			...
			for (var i = e.children || [], n = i.length, o = 0, s = 0; s < n; s++) i[s].direction === t.left ? o-- : o++;
		...
		_layout_direction_root() {
			...
			if (i.direction = t.center, i.side_index = 0, this.isside)
				...
				s = o;
				for (var r = null; s--;)(r = n[s]).direction == t.left ? this._layout_direction_side(r, t.left, s) : this._layout_direction_side(r, t.right, s)
			}
		}
		...
		layout_offset() {
			...
			for (var n = e.children, o = n.length, s = [], r = [], a = null; o--;)(a = n[o])._data.layout.direction == t.right ? r.unshift(a) : s.unshift(a);
			i.left_nodes = s, i.right_nodes = r, i.outer_height_left = this._layout_offset_subnodes(s), i.outer_height_right = this._layout_offset_subnodes(r), this.bounds.e = e._data.view.width / 2, this.bounds.w = 0 - this.bounds.e, this.bounds.n = 0, this.bounds.s = Math.max(i.outer_height_left, i.outer_height_right)
		}
		_layout_offset_subnodes(e) {
			for (var t = 0, i = e.length, n = i, o = null, s = 0, r = null, a = 0, d = null; n--;) r = (o = e[n])._data.layout, null == d && (d = o.parent._data), s = this._layout_offset_subnodes(o.children), o.expanded || (s = 0, this.set_visible(o.children, !1)), s = Math.max(o._data.view.height, s), this._should_reserve_cousin_space(o) && (s += this.opts.cousin_space), r.outer_height = s, r.offset_y = a - s / 2, r.offset_x = this.opts.hspace * r.direction + d.view.width * (d.layout.direction + r.direction) / 2, o.parent.isroot || (r.offset_x += this.opts.pspace * r.direction), a = a - s - this.opts.vspace, t += s;
			i > 1 && (t += this.opts.vspace * (i - 1)), n = i;
			for (var l = t / 2; n--;)(o = e[n])._data.layout.offset_y += l;
			return t
		}
		_layout_offset_subnodes_height(e) {
			for (var t = 0, i = e.length, n = i, o = null, s = 0, r = null, a = 0, d = null; n--;) r = (o = e[n])._data.layout, null == d && (d = o.parent._data), s = this._layout_offset_subnodes_height(o.children), o.expanded || (s = 0), s = Math.max(o._data.view.height, s), this._should_reserve_cousin_space(o) && (s += this.opts.cousin_space), r.outer_height = s, r.offset_y = a - s / 2, a = a - s - this.opts.vspace, t += s;
			i > 1 && (t += this.opts.vspace * (i - 1)), n = i;
			for (var l = t / 2; n--;)(o = e[n])._data.layout.offset_y += l;
			return t
		}
		...
		get_expander_point(e) {
			var i = this.get_node_point_out(e),
				n = {};
			return e._data.layout.direction == t.right ? n.x = i.x - this.opts.pspace : n.x = i.x, n.y = i.y - Math.ceil(this.opts.pspace / 2), n
		}
		get_min_size() {
		...
		expand_node(e) {
			e.expanded = !0, this.part_layout(e), this.set_visible(e.children, !0), this.jm.invoke_event_handle(i.show, {
				evt: "expand_node",
				data: [],
				node: e.id
			})
		...
		collapse_node(e) {
			e.expanded = !1, this.part_layout(e), this.set_visible(e.children, !1), this.jm.invoke_event_handle(i.show, {
				evt: "collapse_node",
				data: [],
				node: e.id
			})
	...
	class f {
		constructor(e) {
			this.opts = e.opts, this.e_canvas = r.c("canvas"), this.e_canvas.className = "jsmind", this.canvas_ctx = this.e_canvas.getContext("2d"), this.size = {
				w: 0,
				h: 0
			}, this.line_drawing = {
				straight: this._line_to,
				curved: this._bezier_to
			}, this.dpr = e.device_pixel_ratio, this.init_line_render()
		}
		init_line_render() {
			"function" == typeof this.opts.custom_line_render ? this.drawing = (e, t, i, n, o) => {
				try {
	...
	class g {
		constructor(e, t) {
			this.opts = t, this.jm = e, this.layout = e.layout, this.container = null, this.e_panel = null, this.e_nodes = null, this.size = {
				w: 0,
				h: 0
			}, this.selected_node = null, this.editing_node = null, this.graph = null, this.render_node = t.custom_node_render ? this._custom_node_render : this._default_node_render, this.zoom_current = 1, this.device_pixel_ratio = this.opts.enable_device_pixel_ratio && r.w.devicePixelRatio || 1, this._initialized = !1
		}
		init() {
			if (s.debug(this.opts), s.debug("view.init"), this.container = r.i(this.opts.container) ? this.opts.container : r.g(this.opts.container), this.container) {
				var e;
				this.graph = (e = this, "svg" === this.opts.engine.toLowerCase() ? new v(e) : new f(e)), this.e_panel = r.c("div"), this.e_nodes = r.c("jmnodes"), this.e_editor = r.c("input"), this.e_panel.className = "jsmind-inner jmnode-overflow-" + this.opts.node_overflow, this.e_panel.tabIndex = 1, this.e_panel.appendChild(this.graph.element()), this.e_panel.appendChild(this.e_nodes), this.e_editor.className = "jsmind-editor", this.e_editor.type = "text";
				var t = this;
		...
		load() {
			s.debug("view.load"), this.setup_canvas_draggable(this.opts.draggable), this.init_nodes(), this._initialized = !0
		}
		expand_size() {
		...
		run_in_c11y_mode_if_needed(e) {
			this.container.offsetParent ? e() : (s.warn("init nodes in compatibility mode. because the container or its parent has style {display:none}. "), this.e_panel.style.position = "absolute", this.e_panel.style.top = "-100000", r.d.body.appendChild(this.e_panel), e(), this.container.appendChild(this.e_panel), this.e_panel.style.position = null, this.e_panel.style.top = null)
		}
		create_node_element(e, t) {
			...
			if (e.isroot) n.className = "root";
				...
				r.t(o, "-"), o.setAttribute("nodeid", e.id), o.style.visibility = "hidden", t.appendChild(o), i.expander = o
			}
		...
		edit_node_end() {
			if (null != this.editing_node) {
				...
				t.style.zIndex = "auto", t.removeChild(this.e_editor), a.text.is_empty(i) || e.topic === i ? this.render_node(t, e) : this.jm.update_node(e.id, i)
			}
			this.e_panel.focus()
		}
		get_view_offset() {
		...
		_show() {
			this.graph.set_size(this.size.w, this.size.h), this.e_nodes.style.width = this.size.w + "px", this.e_nodes.style.height = this.size.h + "px", this.show_nodes(), this.show_lines(), this.jm.invoke_event_handle(i.resize, {
				data: []
			})
		}
		zoom_in(e) {
		...
		set_zoom(e, t) {
			...
			if (e < 1 && e < this.zoom_current && this.size.w * e < i.width && this.size.h * e < i.height) return !1;
			let n = t ? {
					x: t.x - i.x,
					y: t.y - i.y
				} : {
		...
		show(e) {
			s.debug(`view.show: {keep_center: ${e}}`), this.expand_size(), this._show(), e && this.center_node(this.jm.mind.root)
		}
		relayout() {
		...
		show_nodes() {
			...
			for (var r in e) i = (o = (t = e[r])._data.view).element, this.layout.is_visible(t) ? (this.reset_node_custom_style(t), n = this.layout.get_node_point(t), o.abs_x = s.x + n.x, o.abs_y = s.y + n.y, i.style.left = s.x + n.x + "px", i.style.top = s.y + n.y + "px", i.style.display = "", i.style.visibility = "visible", this._show_expander(t, s)) : (i.style.display = "none", o.expander.style.display = "none")
		}
		_show_expander(e, t) {
			if (e.isroot) return;
			var i = e._data.view.expander;
			if (0 == e.children.length) return i.style.display = "none", void(i.style.visibility = "hidden");
			let n = this._get_expander_text(e);
			r.t(i, n);
			let o = this.layout.get_expander_point(e);
			i.style.left = t.x + o.x + "px", i.style.top = t.y + o.y + "px", i.style.display = "", i.style.visibility = "visible"
		}
		...
		setup_canvas_draggable(e) {
			if (this.opts.draggable = e, !this._initialized) {
				let e, t, i = !1;
				this.opts.hide_scrollbars_when_draggable && (this.e_panel.style = "overflow: hidden"), r.on(this.container, "mousedown", (n => {
		...
		center_node(e) {
			if (!this.layout.is_visible(e)) return s.warn("can not scroll to the node, because it is invisible"), !1;
			let t = e._data.view,
	...
	class z {
		...
		constructor(t) {
			z.current = this, this.options = function(e) {
				var t = {};
				if (a.json.merge(t, d), a.json.merge(t, e), !t.container) throw new Error("the options.container should not be null or empty.");
				return t
			}(t), s.level(n[this.options.log_level]), this.version = e, this.initialized = !1, this.mind = null, this.event_handles = [], this.init()
		}
		init() {
			if (!this.initialized) {
				this.initialized = !0;
		...
		begin_edit(e) {
			if (!l.is_node(e)) {
				var t = this.get_node(e);
				return t ? this.begin_edit(t) : (s.error("the node[id=" + e + "] can not be found."), !1)
			}
		...
		_show(e, t) {
			...
			this.mind = this.data.load(n), this.mind ? (s.debug("data.load ok"), this.view.load(), s.debug("view.load ok"), this.layout.layout(), s.debug("layout.layout ok"), this.view.show(!t), s.debug("view.show ok"), this.invoke_event_handle(i.show, {
				data: [e]
		...
		add_node(e, n, o, r, a) {
			if (this.get_editable()) {
				...
				return h && (this.view.add_node(h), this.layout.layout(), this.view.show(!1), this.view.reset_node_custom_style(h), this.expand_node(d), this.invoke_event_handle(i.edit, {
					evt: "add_node",
					data: [d.id, n, o, r, l],
					node: n
				})), h
		...
		insert_node_before(e, n, o, r, a) {
			if (this.get_editable()) {
				...
				return h && (this.view.add_node(h), this.layout.layout(), this.view.show(!1), this.invoke_event_handle(i.edit, {
		...
		remove_node(e) {
			if (!l.is_node(e)) {
				var t = this.get_node(e);
				return t ? this.remove_node(t) : (s.error("the node[id=" + e + "] can not be found."), !1)
			}
			if (this.get_editable()) {
				if (e.isroot) return s.error("fail, can not remove root node"), !1;
				var n = e.id,
					o = e.parent.id,
					r = this.get_node(o);
				return this.view.save_location(r), this.view.remove_node(e), this.mind.remove_node(e), this.layout.layout(), this.view.show(!1), this.view.restore_location(r), this.invoke_event_handle(i.edit, {
					evt: "remove_node",
					data: [n],
					node: o
				}), !0
		...
		update_node(e, t) {
			if (this.get_editable())
				if (a.text.is_empty(t)) s.warn("fail, topic can not be empty");
				else {
					var n = this.get_node(e);
					if (n) {
						if (n.topic === t) return s.info("nothing changed"), void this.view.update_node(n);
						n.topic = t, this.view.update_node(n), this.layout.layout(), this.view.show(!1), this.invoke_event_handle(i.edit, {
							evt: "update_node",
							data: [e, t],
							node: e
						})
		...
		move_node(e, t, n, o) {
			if (this.get_editable()) {
				...
				a && (this.view.update_node(a), this.layout.layout(), this.view.show(!1), this.invoke_event_handle(i.edit, {
					evt: "move_node",
					data: [e, t, n, o],
					node: e
				}))
		...
		select_node(e) {
			...
			this.layout.is_visible(e) && (this.mind.selected = e, this.view.select_node(e), this.invoke_event_handle(i.select, {
				evt: "select_node",
				data: [],
				node: e.id
			}))
		...
		find_node_before(e) {
			...
			var i = null;
			if (e.parent.isroot)
				for (var n = e.parent.children, o = null, r = null, a = 0; a < n.length; a++) r = n[a], e.direction === r.direction && (e.id === r.id && (i = o), o = r);
		...
		set_node_background_image(e, t, i, n, o) {
			...
			r && (t && (r.data["background-image"] = t), i && (r.data.width = i), n && (r.data.height = n), o && (r.data["background-rotation"] = o), this.view.reset_node_custom_style(r), this.view.update_node(r), this.layout.layout(), this.view.show(!1))
		}
		set_node_background_rotation(e, t) {
			if (!this.get_editable()) return s.error("fail, this mind map is not editable"), null;
			var i = this.mind.get_node(e);
			if (i) {
				if (!i.data["background-image"]) return s.error("fail, only can change rotation angle of node with background image"), null;
